...
VSEL,ALL
VSEL,S,LOC,X,-0.0001,SLEEPER_L+0.0001
*DO,i,2,SLAB_KJN
  VSEL,A,LOC,X,(i-1)*KJJJ-0.0001,(i-1)*KJJJ+SLEEPER_L+0.0001
*ENDDO
...
!底座板DZ
WPCSYS,-1
WPOFFS,,H1+H2-SLAB_H,(BASE_W-H)/2
...
WPCSYS,-1
WPOFFS,AC_BD-AC_L/2+XJDC_H,H1+H2-SLAB_H,-(H-AC_W)/2-XJDC_H
BLC4,0,0,AC_L-2*XJDC_H,-AC_H,-(AC_W-2*XJDC_H)
VSEL,U,,,DZ1
CM,AC1,VOLU
